...
-- I had to add Control.Monad (when,zipWithM_) because they are not part of Control.Monad.State.
-- This caused an error in the original version.
...
-- Original version did not contain Applicative as derived instance.
